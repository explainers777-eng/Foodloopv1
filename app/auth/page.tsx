...
export default function AuthPage() {
  return (
    <main className="section-shell grid min-h-[calc(100vh-9rem)] place-items-center py-10">
      <section className="glass-card w-full max-w-md p-6">
        <div className="mb-6 grid size-14 place-items-center border-4 border-black bg-[#2f6f5e] text-white">
