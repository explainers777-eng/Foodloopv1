...
export function SiteFooter() {
  return (
    <footer className="border-t border-forest-100 bg-white/80 py-10 dark:border-white/10 dark:bg-slate-950">
      <div className="section-shell grid gap-8 md:grid-cols-[1.3fr_1fr_1fr]">
        <div>
          <div className="mb-3 flex items-center gap-2 text-lg font-bold">
            <span className="grid size-9 place-items-center rounded-2xl bg-forest-600 text-white">
        ...
        <div className="grid gap-2 text-sm text-slate-600 dark:text-slate-300">
          ...
          <Link href="/post">Post surplus</Link>
