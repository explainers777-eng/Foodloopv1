...
export function LiveListings() {
  ...
  return (
    <>
      <div className="animate-in mb-8 grid gap-4 md:grid-cols-[1fr_auto] md:items-end">
        <div>
          <p className="animate-pop mb-3 inline-flex items-center gap-2 border-4 border-black bg-[#b7e4c7] px-4 py-2 text-sm font-black text-black shadow-[5px_5px_0_#000]">
            <Sparkles className="size-4 animate-wiggle" /> Verified charities only
          </p>
        ...
        <div className="animate-pop border-4 border-black bg-white px-5 py-3 text-sm font-black shadow-[6px_6px_0_#000]">
          {availableListings.length} live listings
        </div>
      </div>

      <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
        <aside className="glass-card motion-panel h-fit p-5 lg:sticky lg:top-24">
        ...
        {!isApproved ? (
          <section className="retro-window motion-panel grid min-h-96 place-items-center p-8 text-center">
            <div>
          ...
          <section className="stagger-list grid gap-5 md:grid-cols-2 xl:grid-cols-3">
